...
Transcribe un archivo de audio de una consulta médica. El flujo es asíncrono: primero creas una sesión, luego subes el audio, luego haces polling para obtener el resultado.
...
Convierte una transcripción de consulta médica en un expediente clínico estructurado usando AI. Extrae automáticamente: motivo de consulta, SOAP completo, diagnóstico, medicamentos y signos vitales.
